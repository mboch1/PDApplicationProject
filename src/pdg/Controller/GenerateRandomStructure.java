...
public class GenerateRandomStructure extends Generator {
	...
	public GenerateRandomStructure(GameModel gm) {
		model = gm;
	}

	public mxGraphComponent generateGraph(int nodes, int edges, long seed) {

		// create a JGraphT graph
		GraphGenerator<Integer, DefaultEdge, Integer> gen = new GnmRandomGraphGenerator<Integer, DefaultEdge>(nodes,
				edges, seed, false, false);
