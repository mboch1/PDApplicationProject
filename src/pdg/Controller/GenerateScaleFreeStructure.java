...
public class GenerateScaleFreeStructure extends Generator {
	...
	public GenerateScaleFreeStructure(GameModel gm) {
		model = gm;
	}

	public mxGraphComponent generateGraph(int nodes, long seed) {
		// create a JGraphT graph
		GraphGenerator<Integer, DefaultEdge, Integer> gen = new ScaleFreeGraphGenerator<>(nodes, seed);
